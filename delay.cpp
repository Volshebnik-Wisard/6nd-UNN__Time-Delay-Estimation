...
// delay.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CdelayApp, CWinApp)
...
// Единственный объект CdelayApp

CdelayApp theApp;


// Инициализация CdelayApp

BOOL CdelayApp::InitInstance()
{
